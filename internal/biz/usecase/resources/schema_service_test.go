...
func TestCalculateTuples(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			sc := NewSchemaUsecase(repo, data.NewInMemorySchemaRepository(), log.NewHelper(log.DefaultLogger))
...
func TestSchemaServiceImpl_ValidateReporterForResource(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			sc := NewSchemaUsecase(data.NewFakeResourceRepository(), fakeRepo, log.NewHelper(log.DefaultLogger))
